...
srcdir = ext
topdir = /Users/rlude/.rubies/ruby-2.0.0-p576/include/ruby-2.0.0
hdrdir = $(topdir)
arch_hdrdir = /Users/rlude/.rubies/ruby-2.0.0-p576/include/ruby-2.0.0/x86_64-darwin14.0.0
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = /Users/rlude/.rubies/ruby-2.0.0-p576
...
DEFS     = 
CPPFLAGS =  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT -I/usr/local/opt/openssl/include -I/usr/local/opt/readline/include -I/usr/local/opt/libyaml/include -I/usr/local/opt/gdbm/include $(DEFS) $(cppflags)
...
ORIG_SRCS = memorandum.c
SRCS = $(ORIG_SRCS) 
OBJS = memorandum.o
HDRS = 
TARGET = memorandum
TARGET_NAME = memorandum
...
pre-install-rb-default:
	$(ECHO) installing default memorandum libraries
./.RUBYARCHDIR.time:
